...
var file_echo_proto_rawDesc = []byte{
	...
	0x28, 0x01, 0x42, 0x07, 0x5a, 0x05, 0x65, 0x63, 0x68, 0x6f, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
func (x *echoServiceEchoClient) Send(m *Word) error {
	return x.ClientStream.SendMsg(m)
}

func (x *echoServiceEchoClient) CloseAndRecv() (*Word, error) {
...
func (x *echoServiceEchoServer) SendAndClose(m *Word) error {
	return x.ServerStream.SendMsg(m)
}

func (x *echoServiceEchoServer) Recv() (*Word, error) {
	m := new(Word)
